<?php
session_start();
// Hapus require_once '../config/database.php'; untuk sementara, 
// karena versi Anda masih hardcoded dan ini untuk menghindari error jika koneksi DB masih bermasalah
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Verifikasi Hardcoded (sesuai file Anda)
                    ...
                    <svg width="60" height="60" viewBox="0 0 60 60" fill="none">
                        ...
                        <defs>
                            <linearGradient id="gradient1" x1="0" y1="0" x2="60" y2="60">
                                <stop offset="0%" stop-color="#1b3270"/>
